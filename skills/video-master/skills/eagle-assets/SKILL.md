...
2. For an active video project, read `../../references/eagle-assets.md` and keep all default operations read-only: search/inspect/select in Eagle, then write only the project's `sources/eagle_assets_manifest.json`.
...
- Catalog-first recall and curation: `../../references/eagle-catalog.md`
